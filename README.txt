...
The program will output the board to a text file as well as the the output panel. It will print the full chessboard with 'q's to indicate the Queens, as well as an array of the Queen's index/position on each row. 
